...
CTR_STATIC_ASSERT(offsetof(struct Driver, originToCenter) == 0x94);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->originToCenter) == 0xc);
CTR_STATIC_ASSERT(offsetof(struct Driver, currBlockTouching) == 0xa0);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->currBlockTouching) == 0x4);
CTR_STATIC_ASSERT(offsetof(struct Driver, normalVecUP) == 0xa4);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->normalVecUP) == 0x6);
CTR_STATIC_ASSERT(offsetof(struct Driver, collisionFlags) == 0xaa);
CTR_STATIC_ASSERT(offsetof(struct Driver, spsHitPos) == 0xac);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->spsHitPos) == 0x6);
CTR_STATIC_ASSERT(offsetof(struct Driver, padding_0xb2) == 0xb2);
CTR_STATIC_ASSERT(offsetof(struct Driver, spsNormalVec) == 0xb4);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->spsNormalVec) == 0x6);
...
CTR_STATIC_ASSERT(offsetof(struct Driver, posPrev) == 0x2e0);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->posPrev) == 0xc);
CTR_STATIC_ASSERT(offsetof(struct Driver, rotCurr) == 0x2ec);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->rotCurr) == 0x8);
CTR_STATIC_ASSERT(offsetof(struct Driver, rotPrev) == 0x2f4);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->rotPrev) == 0x8);
CTR_STATIC_ASSERT(offsetof(struct Driver, underDriver) == 0x350);
CTR_STATIC_ASSERT(offsetof(struct Driver, lastValid) == 0x354);
CTR_STATIC_ASSERT(offsetof(struct Driver, terrainMeta1) == 0x358);
CTR_STATIC_ASSERT(offsetof(struct Driver, terrainMeta2) == 0x35c);
CTR_STATIC_ASSERT(offsetof(struct Driver, AxisAngle1_normalVec) == 0x360);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->AxisAngle1_normalVec) == 0x6);
...
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->AxisAngle2_normalVec) == 0x6);
...
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->AxisAngle3_normalVec) == 0x6);
CTR_STATIC_ASSERT(offsetof(struct Driver, AxisAngle4_normalVec) == 0x378);
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->AxisAngle4_normalVec) == 0x6);
...
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->forwardAccelVector) == 0x6);
...
CTR_STATIC_ASSERT(sizeof(((struct Driver *)0)->posWallColl) == 0x6);
