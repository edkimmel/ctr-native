...
struct NativeCanonicalDriversRosterInput {
	struct NativeCanonicalDriversRosterSlot slots[8]; uint8_t raceOrderCount, raceOrder[8], winnerCount, winnerDriverIDs[4], playerCount, ranks[8], navCount[3], navOrder[3][8];
};
