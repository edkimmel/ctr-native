...
static int TestDomainAndVersionInvariants(void)
{
	...
	CHECK(NATIVE_CANONICAL_STATE_SCHEMA_VERSION == UINT32_C(3));
	CHECK(NATIVE_CANONICAL_REPLAY_FORMAT_VERSION == UINT32_C(3));
	CHECK(NATIVE_CANONICAL_STATE_SCHEMA_VERSION_V2 == UINT32_C(2));
	CHECK(NATIVE_CANONICAL_REPLAY_FORMAT_VERSION_V2 == UINT32_C(2));
